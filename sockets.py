...
# https://www.gevent.org/api/gevent.greenlet.html#gevent.Greenlet
app = Flask(__name__)
sockets = Sockets(app)
app.debug = True
clientList=[]
...
def set_listener( entity, data ):
    ...
    for client in clientList:
        client.put_nowait(json.dumps(update))
...
def update(entity):
    ...
    updates:dict = flask_post_json()
    for update in updates.keys():
        myWorld.update(entity,update,updates[updates])
    return flask.jsonify(myWorld.world()) if request.method!="PUT" else flask.jsonify(updates)
